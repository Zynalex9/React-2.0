...
function Header() {
  ...
  const activeClass =
    "block py-2 px-3 text-blue-700 rounded md:p-0 md:dark:text-blue-500";
  const inActiveClass =
  ...
  return (
    <>
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-2 dark:border-gray-200">
